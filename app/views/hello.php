...
<body>
	<div class="welcome">
		...
		<?php echo $lastname ?>
		<br>
		<?php echo action('HomeController@showWelcome') ?>
		<br>
		<?php echo URL::action('HomeController@showWelcome') ?>
		<br>
		<?php echo Route::currentRouteAction() ?>
		<a href=<?php echo URL::route('test')?> >HERE</a>
		<a href=<?php echo URL::route('wahaha')?> >THERE</a>

		<a href=<?php echo URL::route('item.index')?> >ITEMS INDEX</a>
	</div>
</body>
</html>
